// Databricks notebook source exported at Mon, 16 May 2016 20:19:41 UTC
...
// MAGIC %md
// MAGIC Our VCF file of the subset of chromosome 6 data contains the genotypes for 2504 people at all the locations which are variants. A quick view of the VCF file is below. The data we will need to analyze starts on line 251 of the file. 
...
// MAGIC %md
// MAGIC Our Sample Panel file contains columns for person ID (sample), population code (pop), super population code (super_pop), and gender.  This will be our lookup panel for each person's population membership for our supervised learning model.
// MAGIC 
...
// MAGIC 
// MAGIC [![](http://cdn2.hubspot.net/hubfs/438089/Images/genome-lightning-viz.png?t=1463090786523)](http://public.lightning-viz.org/visualizations/0d3defe5-db48-4d41-9b89-5c6cbd562212/public/)
// MAGIC 
